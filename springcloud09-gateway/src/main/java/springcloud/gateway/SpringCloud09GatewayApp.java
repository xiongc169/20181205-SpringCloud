...
public class SpringCloud09GatewayApp {
    ...
    public static void main(String[] args) {
        System.out.println(sdFormat.format(new Date()) + " SpringCloud09GatewayApp Start...");
        SpringApplication.run(SpringCloud09GatewayApp.class, args);
        System.out.println(sdFormat.format(new Date()) + " SpringCloud09GatewayApp Finished");
    }
